...
if __name__ == '__main__':
    dataset_dir = '../search_engine_slidevqa/corpus'
    ingestion = Ingestion(dataset_dir,input_prefix='img',output_prefix='dse_ingestion',embed_model_name='/data/user0/models/Tevatron/dse-phi3-docmatix-v1') # colqwen2
